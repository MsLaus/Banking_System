...
public class DashboardController extends SQLConnection implements Initializable {
    ...
    final String NUMBER_ACCOUNT = user.getAccount_number();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        balanceLabel.setText(getBalance(conn, user.getAccount_number()));
    ...
    private void refreshTable() throws SQLException {
        ...
        list.clear();
        Optional<TableColumn<Transaction, String>> optional = getTransactions();
        if(!optional.isPresent()){
            insertTransaction(conn, user.getAccount_number(), "deposit", user.getBalance(), dtf.format(now));
        }else {
            query = String.format("SELECT * FROM transactions WHERE account_number = '%s'", user.getAccount_number());
    ...
    private Optional<TableColumn<Transaction, String>> getTransactions(){

        try {
            query = String.format("SELECT * FROM transactions WHERE account_number = '%s'",
